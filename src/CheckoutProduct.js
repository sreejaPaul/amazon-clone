            ...
            <div className="checkoutProductInfo">
                ...
                <div style={{ display: "flex", marginTop: "20px" }}>
                    <div style={{ marginRight: "100px" }}>
                        {!hideButton && <button onClick={removeProductFromList} className={(count > 1) ? "checkBtn" : "addOn"}><RemoveIcon style={{ paddingTop: "5px" }} fontSize={"small"} /></button>}
                        <span style={{ padding: "0px 5px 0px 5px", marginTop: "20px" }}>
                            {"Quantity : " + count}
                        </span>
                        {!hideButton && <button onClick={addItemToBasket} className="checkBtn" style={{ paddingTop: "5px" }} fontSize={"small"}><AddIcon /></button>}
                    </div>
                    {!hideButton && (<div>
